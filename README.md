...
|                                                유저/인증 도메인 <br/> 결제 도메인 <br/> 모니터링 환경 구축 <br/> AWS 인프라 구성                                                |                                                                                                                                   리워드 도메인 <br/> 모니터링 환경 구축 <br/> AWS 인프라 구성                                                                                                                                    |                                          프로젝트 도메인 <br/> CI/CD 파이프라인 구성 <br/> 모니터링 환경 구축 <br/> AWS 인프라 구성                                           |                                                                                                                            펀딩 도메인 <br/> 후원하기 API 성능개선 <br/> 스케쥴러 분산락 적용 <br/> AWS 인프라 구성                                                                                                                            |
